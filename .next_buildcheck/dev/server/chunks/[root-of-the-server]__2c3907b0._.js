...
"[project]/src/services/AnalyticsService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/best-opportunities/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AnalyticsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/AnalyticsService.ts [app-route] (ecmascript)");
;
;
;
async function POST(request) {
    try {
        ...
        const { watchlist, riskProfile } = body;
        if (!watchlist || !Array.isArray(watchlist) || watchlist.length < 2) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Invalid watchlist (minimun 2 required)"
            }, {
                status: 400
            });
        }
        const allAssets = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$MarketDataService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["marketDataService"].getAssets()).flat();
        const selectedAssets = allAssets.filter((a)=>watchlist.includes(a.ticker));
        const marketDataMap = new Map();
        for (const asset of selectedAssets){
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$MarketDataService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["marketDataService"].getMarketData(asset.ticker);
            if (!data.error) {
        ...
        for (const asset of selectedAssets){
            ...
            const volatility = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AnalyticsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["analyticsService"].calculateVolatility(data);
            const momentum = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AnalyticsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["analyticsService"].calculateMomentum(data);
            const maxDrawdown = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AnalyticsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["analyticsService"].calculateMaxDrawdown(data);
            let score = 0;
            ...
            if (marketDataMap.size > 1) {
                ...
                for (const [otherTicker, otherData] of marketDataMap.entries()){
                    if (otherTicker !== asset.ticker) {
                        const corr = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AnalyticsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["analyticsService"].calculateCorrelation(data, otherData);
        ...
        const ranked = scoredAssets.sort((a, b)=>b.score - a.score).map((s)=>s.asset);
        const response = {
            ranked,
            explanations,
            correlationMatrix
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c3907b0._.js.map